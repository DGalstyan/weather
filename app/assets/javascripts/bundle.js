	    ...
	    if (weather.response) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'location-info left' },
	            React.createElement(
	              'h2',
	              { className: 'location-name dark-gray' },
	              city + ", " + province
	            ),
	            React.createElement(
	              'h4',
	              { className: 'location-time dark-gray' },
	              lastUpdate
	            )
	          ),
	          React.createElement(Autocomplete, { changeLocation: this.props.changeLocation }),
	          React.createElement(ToggleLocation, { location: weather.location })
	        ),
	        React.createElement(Conditions, { weather: weather }),
	        React.createElement(Hourly, { weather: weather })
	      );
	    } else {
	      return React.createElement('div', null);
	    }
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'h4',
	          { className: 'current-weather alert' },
	          alert
	        ),
	        React.createElement(
	          'div',
